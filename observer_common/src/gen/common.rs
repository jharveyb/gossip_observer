...
/// 33-byte compressed secp256k1 point, raw (not hex).
/// WIRE-BREAKING vs the old hex-string encoding: collectors and controller
/// must be deployed together across this change.
...
pub struct OpenChannelResponse {
    #[prost(bytes = "bytes", tag = "1")]
    pub local_channel_id: ::prost::bytes::Bytes,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]

...
static MSG_DIR_OUT: &str = "outbound";
// Pulled from the DB, generated from a test run with v0.0.3
pub static RAW_NODE_ANNOUNCEMENT: &str = "czerMr77LaTl7sefneoCxYCNvjBlF6IB9GsqxQpizNgDIaG9693U0m5OoJNJPvSxPZ6EA3S-2P2B__A7MmBwRHMcp7SjRyZ67bOIPQ6YlqMa-qq7AEy7WbCNobNuLWhr3QAyYH";
...
// Example pong message.
pub fn v0_outbound_pong_msg() -> String {
    format!(
        "{TIMESTAMP_UNIX_USEC},{NODE_KEY},{MSG_TYPE_PONG},{MSG_DIR_OUT},{MSG_SIZE},{B64_MSG_NO_SIG},,,,{NODE_3_KEY}"
    )
}
